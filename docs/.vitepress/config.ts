      ...
      '/user-guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Analytics Overview', link: '/user-guide/analytics-overview' },
      ...
      '/developer-guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Analytics', link: '/developer-guide/analytics' },
      ...
      '/api/': [
        {
          ...
          items: [
            ...
            { text: 'Tenant Analytics', link: '/api/tenant-v1-analytics' },
      ...
      '/deployment/': [
        {
          ...
          items: [
            ...
            { text: 'Analytics Production Readiness', link: '/deployment/analytics-production-readiness' },
