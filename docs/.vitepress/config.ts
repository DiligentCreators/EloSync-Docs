      ...
      '/user-guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Live Chat Overview', link: '/user-guide/live-chat-overview' },
            { text: 'Live Chat', link: '/user-guide/live-chat' },
            ...
            { text: 'Tax types', link: '/user-guide/tax-types' },
            ...
            { text: 'AI Assistant', link: '/user-guide/ai-assistant' },
            { text: 'Assets Overview', link: '/user-guide/assets-overview' },
            { text: 'Assets', link: '/user-guide/assets' },
            { text: 'Short Links', link: '/user-guide/short-links' },
            { text: 'Documents Overview', link: '/user-guide/documents-overview' },
            { text: 'Documents', link: '/user-guide/documents' },
            { text: 'WhatsApp Cloud Overview', link: '/user-guide/whatsapp-cloud-overview' },
            { text: 'WhatsApp Cloud', link: '/user-guide/whatsapp-cloud' },
      ...
      '/developer-guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Tenant API & Webhooks', link: '/developer-guide/tenant-api-webhooks' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Live Chat', link: '/developer-guide/live-chat' },
            ...
            { text: 'Tax types', link: '/developer-guide/tax-types' },
            ...
            { text: 'AI Tools', link: '/developer-guide/ai-tools' },
            { text: 'AI Credits', link: '/developer-guide/ai-credits' },
            { text: 'Assets', link: '/developer-guide/assets' },
            { text: 'Short Links', link: '/developer-guide/short-links' },
            { text: 'Documents', link: '/developer-guide/documents' },
            { text: 'Communication Templates', link: '/developer-guide/communication-templates' },
            { text: 'WhatsApp Cloud API', link: '/developer-guide/whatsapp-cloud-integration' },
      ...
      '/api/': [
        {
          ...
          items: [
            ...
            { text: 'Tenant Developers', link: '/api/tenant-v1-developers' },
            ...
            { text: 'Tenant Live Chat', link: '/api/tenant-v1-live-chat' },
            ...
            { text: 'Tenant Tax types', link: '/api/tenant-v1-tax-types' },
            ...
            { text: 'Tenant AI', link: '/api/tenant-v1-ai' },
            { text: 'Tenant Assets', link: '/api/tenant-v1-assets' },
            { text: 'Tenant Short Links', link: '/api/tenant-v1-short-links' },
            { text: 'Tenant Documents', link: '/api/tenant-v1-documents' },
            { text: 'Tenant WhatsApp Cloud', link: '/api/tenant-v1-whatsapp-cloud' },
      ...
      '/deployment/': [
        {
          ...
          items: [
            ...
            { text: 'Tenant API & Webhooks Production Readiness', link: '/deployment/tenant-api-webhooks-production-readiness' },
            ...
            { text: 'Assets', link: '/deployment/assets' },
            ...
            { text: 'AI Expense Triage Production Readiness', link: '/deployment/ai-expense-triage-production-readiness' },
            { text: 'AI Project Triage Production Readiness', link: '/deployment/ai-project-triage-production-readiness' },
            { text: 'AI Purchase Order Triage Production Readiness', link: '/deployment/ai-purchase-order-triage-production-readiness' },
            { text: 'AI Payment Triage Production Readiness', link: '/deployment/ai-payment-triage-production-readiness' },
            { text: 'AI Lead Assign + Note Production Readiness', link: '/deployment/ai-lead-assign-note-production-readiness' },
            { text: 'AI Estimate Triage Production Readiness', link: '/deployment/ai-estimate-triage-production-readiness' },
