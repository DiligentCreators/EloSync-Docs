...
| [Team Chat](/user-guide/team-chat) | ✅ Completed (channels/DMs, mentions, threads/reactions/pins/typing, attachments/search/retention; free Collaboration opt-in; catalog **1.2.0**) |
