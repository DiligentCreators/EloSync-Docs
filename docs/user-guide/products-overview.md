...
Phase 5 Inventory module on the frozen platform. Products is the tenant catalog for goods and services, used by Inventory and optionally by Purchase Order lines.
