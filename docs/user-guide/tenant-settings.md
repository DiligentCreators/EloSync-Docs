...
| **Trash retention** | How long soft-deleted items stay in Trash before automatic permanent purge (`trash.retention_days`). Choose **30**, **90**, or **365** days, or **Forever**. Applies to leads, tasks, contacts, companies, invoices, and other SoftDeletes modules (not Team Chat messages — see Team Chat retention; not IMAP Email Trash folders). |
