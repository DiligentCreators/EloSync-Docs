...
| Storage | Storage (+ packs) | Free `storage` unlocks 1 GB; billable packs `storage-10` … `storage-1000` set total allowance |

Default-included today: **Leads**, **Tasks** only. Paid examples: **Branded**, **Automation**, **Storage packs**. See [Entitlements](/developer-guide/entitlements).
