...
- [ ] Frontend complete (list + dedicated create/view/edit pages, forms, tables, filters, loading/empty/error states; dialogs only for secondary flows)
