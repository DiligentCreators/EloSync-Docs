...
- **Go:** local Pest Analytics **20/20**; headed Playwright **14/14**; Docs / Frontend Quality Gates green; Backend Code Quality Gate + Laravel Tests green (dispatched). Staging migrate **1.3.1** + smoke remain.
