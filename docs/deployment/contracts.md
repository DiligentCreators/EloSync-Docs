...
- Notifications: assignment via `ContractAssignedNotification`; renewal due via `ContractRenewalDueNotification` (database; scheduled by `crm:send-due-notifications`)
