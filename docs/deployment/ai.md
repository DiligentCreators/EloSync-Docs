...
- `ai_provider`, `ai_api_key`, default / fast / advanced models
...
- Settings → **AI** — requires **`ai.manage`** (+ `settings.update`); mode (`platform` \| `byok`), optional tenant key, assistant toggles, instructions
